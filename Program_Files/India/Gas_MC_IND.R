...
library(dplyr)
dde1= Data %>% select(country,year,population,gdp,gas_electricity,gas_production,gas_share_elec,gas_share_energy,gas_consumption) %>% filter(country == "India" & year >= 1990 & year <=2018)
View(dde1)
summary(dde1)
str(dde1)
