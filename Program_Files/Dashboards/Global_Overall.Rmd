...
dde1 <- dde1[complete.cases(dde1),]%>% filter(year >= 1990 & year <=2018) %>% filter(coal_consumption > 0)
View(dde1)
summary(dde1)
str(dde1)
...
cor(dde_test_0$coal_consumption, predicted_cons)
...
(ggplotly(Line<- ggplot(dde_test_0
            ...
            xlab("Year") +
            ylab("Consumption Values") +
            ggtitle("Global Coal Consumption Predicted Vlaues")))
